  ...
  return (
    <div className="w-full flex justify-center flex-col items-center">
      <div className="flex items-center flex-col">
        <p className="mb-3">Introducing Pet Scheduler</p>
        <h1 className="text-6xl font-bold mb-10 text-center">
          Pet scheduling made simple
        </h1>
        <h2 className="w-1/2 text-center">
          Pet Scheduler offers a robust dashboard for managing clients.
          Effortlessly schedule pet care appointments for owners and
          professionals.
        </h2>
      </div>
      ...
      <div className="flex align-center justify-center">
        <Image
          src={PetSchedulesTeam}
          alt="PetSchedules Team"
